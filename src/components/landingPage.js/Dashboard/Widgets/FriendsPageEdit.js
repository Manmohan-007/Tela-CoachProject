            ...
            <ul className="widget w-friend-pages-added notification-list friend-requests">
                <li className="inline-items">
                    <div className="author-thumb">
                        <img loading="lazy" src="https://cdn.auth0.com/blog/react-js/react.png" alt="author" />
                    </div>
                    <div className="notification-event">
                        <a href="" className="h6 notification-friend">React Course</a>
                ...
                <li className="inline-items">
                    <div className="author-thumb">
                        <img loading="lazy" src="https://secureservercdn.net/198.71.233.135/0eb.6c6.myftpupload.com/wp-content/uploads/Web-Pixels-Logo-light-background.png" alt="author" />
                    </div>
                    <div className="notification-event">
                        <a href="" className="h6 notification-friend">Pixel Digital Design</a>
                        <span className="chat-message-item">Designing Course</span>
                    </div>
                    <span className="notification-icon" data-toggle="tooltip" data-placement="top" data-original-title="ADD TO YOUR FAVS">
                        <a href="">
                            <svg className="olymp-star-icon"><use xlinkHref="#olymp-star-icon" /></svg>
