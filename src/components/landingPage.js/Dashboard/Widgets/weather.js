        ...
        return (
            <div className="widget w-wethear">
                ...
                <div className="wethear-now inline-items">
                    ...
                    <svg className="olymp-weather-partly-sunny-icon"><use xlinkHref="#olymp-weather-partly-sunny-icon" /></svg>
                </div>
                ...
                <ul className="weekly-forecast">
                    <li>
                        ...
                        <svg className="olymp-weather-sunny-icon"><use xlinkHref="#olymp-weather-sunny-icon" /></svg>
                    ...
                    <li>
                        ...
                        <svg className="olymp-weather-cloudy-icon"><use xlinkHref="#olymp-weather-cloudy-icon" /></svg>
                        <div className="temperature-sensor-day">67°</div>
                    </li>
                    <li>
                        <div className="day">wed</div>
                        <svg className="olymp-weather-rain-icon"><use xlinkHref="#olymp-weather-rain-icon" /></svg>
                        <div className="temperature-sensor-day">70°</div>
                    </li>
                    <li>
                        <div className="day">thu</div>
                        <svg className="olymp-weather-storm-icon"><use xlinkHref="#olymp-weather-storm-icon" /></svg>
                        <div className="temperature-sensor-day">58°</div>
                    </li>
                    <li>
                        <div className="day">fri</div>
                        <svg className="olymp-weather-snow-icon"><use xlinkHref="#olymp-weather-snow-icon" /></svg>
                        <div className="temperature-sensor-day">68°</div>
                    </li>
                    <li>
                        <div className="day">sat</div>
                        <svg className="olymp-weather-wind-icon-header"><use xlinkHref="#olymp-weather-wind-icon-header" /></svg>
